...
admin.site.site_header = "Track"
admin.site.site_title = "Track Admin Portal"
admin.site.index_title = "Track Admin"

# swagger
api_info = openapi.Info(
    title="Track API",
    default_version="v1",
    description="API documentation for Track App",
)
